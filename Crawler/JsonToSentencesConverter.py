...
def convert(source = '../Data/sampleFromDataCrowlerindeed1001.json', destination = '../Data/data_for_voc_1001.json'):
    print('Start')
...
if __name__ == '__main__':
    convert('../Data/sampleFromDataCrowlerindeed1001.json', '../Data/data_for_voc_1001.json')
